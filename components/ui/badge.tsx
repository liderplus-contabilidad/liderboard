...
const VARIANTS: Record<BadgeVariant, string> = {
  ...
  // The third status tone («Vencida»): red, for what is already late.
  negative:
    "rounded-full bg-negative/10 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.6px] text-negative",
};
